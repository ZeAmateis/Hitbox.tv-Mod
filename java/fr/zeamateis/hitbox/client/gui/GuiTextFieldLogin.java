...
public class GuiTextFieldLogin extends Gui {
	...
	public GuiTextFieldLogin(int componentId, FontRenderer fontrendererObj, int x, int y, int par5Width, int par6Height) {
		this.id = componentId;
	 ...
	 * 
	 * @param guiResponderIn
	 *            The new GuiResponder to use
	 */
	 ...
	 * 
	 * @param textIn
	 *            The text to set. Will be trimmed if longer than the maximum
	 *            length.
	 */
	 ...
	 * 
	 * @param num
	 *            Number of words to delete. If negative, words are deleted from
	 *            behind the cursor (IE, backspace). If positive, words are
	 *            deleted from in front of the cursor (IE, the delete key on
	 *            PCs).
	 */
	 ...
	 * 
	 * @param num
	 *            Number of characters to delete. If negative, letters are from
	 *            behind the cursor (IE, backspace). If positive, letters are
	 *            deleted from in front of the cursor (IE, the delete key on
	 *            PCs).
	 */
	 ...
	 * 
	 * @param numWords
	 *            The number of words away to look. If negative, it looks behind
	 *            the cursor; if positive, it looks in front of the cursor. If
	 *            0, the current cursor position is returned.
	 */
	 ...
	 * @param n
	 *            The number of words away to look. If negative, it looks behind
	 *            the given position; if positive, it looks in front of the
	 *            given position. If 0, the position is returned.
	 * @param pos
	 ...
	 * @param skipWs
	 *            Whether consecutive spaces should be skipped. If set to false,
	 *            then checking more than one word does not work.
	 */
	 ...
	 * 
	 * @param num
	 *            The number of characters to move the cursor by. May be
	 ...
	 * 
	 * @param pos
	 *            The new position for the cursor. Will be clamped to between 0
	 ...
	 * @param keyCode
	 *            LWJQL key code for the key that was pressed.
	 */
	 ...
	 *            Mouse y coordinate
	 * @param mouseButton
	 *            The on the mouse that was pressed
	 */
	 ...
	 * 
	 * @param startX
	 *            The x coordinate to start drawing at. If beyond the edge of
	 *            the text box, it will be moved to the edge.
	 * @param startY
	 *            The y coordinate to start drawing at.
	 * @param endX
	 *            The x coordinate to stop drawing at. If beyond the edge of the
	 *            text box, it will be moved to the edge.
	 * @param endY
	 *            The y coordinate to stop drawing at.
	 */
	 ...
	 * drawn.
	 * 
	 * @param enableBackgroundDrawingIn
	 *            True if the background and outline should be drawn.
	 */
	 ...
	 * 
	 * @param color
	 *            The new color to use for disabled text
	 */
	 ...
	 * 
	 * @param isFocusedIn
	 *            True if this text box is focused.
	 */
	 ...
	 * 
	 * @param enabled
	 *            True if the text box is enabled
	 */
	 ...
	 * clicked.
	 * 
	 * @param canLoseFocusIn
	 *            True if this text box loses focus when something other than it
	 *            is clicked
	 */
	 ...
	 * 
	 * @param isVisible
	 *            True if this text box is visible
	 */
