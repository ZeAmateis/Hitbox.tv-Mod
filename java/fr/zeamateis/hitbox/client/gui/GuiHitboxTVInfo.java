...
public class GuiHitboxTVInfo extends GuiScreen {
	...
	public void drawScreen(int mouseX, int mouseY, float partialTicks) {
		...
		if (this.isStreaming) {
			// Channel Name
			this.fontRendererObj.drawString(TextFormatting.GREEN + channelOnline, this.width / 2 - this.fontRendererObj.getStringWidth(channelOnline) / 2, this.height / 2 - 78, -1);

			// Live Title
			// TODO Split title
			this.fontRendererObj.drawString(TextFormatting.UNDERLINE + liveTitle, this.width / 2 - this.fontRendererObj.getStringWidth(liveTitle) / 2, this.height / 2 - 50, -1);

			// Game Played
			this.fontRendererObj.drawString(TextFormatting.ITALIC + gamePlayed, this.width / 2 - this.fontRendererObj.getStringWidth(gamePlayed) / 2, this.height / 2 - 65, -1);

			// Total Viewers on live
			this.fontRendererObj.drawString(streamingViewers, this.width / 2 - 118, this.height / 2 - 25, -1);
		} else {
			this.fontRendererObj.drawString(TextFormatting.RED + channelOffline, this.width / 2 - this.fontRendererObj.getStringWidth(channelOffline) / 2, this.height / 2 - 78, -1);
		}

		// Get Total Channel Views
		this.fontRendererObj.drawString(TextFormatting.UNDERLINE + channelTotalViews, this.width / 2 - 118, this.height - 52, -1);
		// Get channel followers
		this.fontRendererObj.drawString(TextFormatting.UNDERLINE + followers, this.width / 2 - 118, this.height - 70, -1);
