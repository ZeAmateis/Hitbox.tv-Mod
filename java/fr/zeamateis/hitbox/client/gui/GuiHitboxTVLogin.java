...
public class GuiHitboxTVLogin extends GuiScreen {
	...
	private boolean isChannelNameCorrect;
	...
	public void initGui() {
		...
		this.password = new GuiTextFieldLogin(this.fontRendererObj, this.width / 2 - 98, this.height / 2 + 32, 100, 20);
		this.password.setEnableBackgroundDrawing(false);
		this.password.setMaxStringLength(100);
		this.password.setText("");

		this.username = new GuiTextField(this.fontRendererObj, this.width / 2 - 98, this.height / 2 - 1, 100, 20);
		this.username.setEnableBackgroundDrawing(false);
		this.username.setFocused(true);
		this.username.setMaxStringLength(128);
		this.username.setText("");

		this.channelName = new GuiTextField(this.fontRendererObj, this.width / 2 - 98, this.height / 2 + 65, 100, 20);
		...
		case 1:
			...
			try {
				if (HitboxTVCore.getData().isHitboxChannelNameCorrect(this.channelName.getText())) {
					this.isChannelNameCorrect = true;
	...
	protected void keyTyped(char p_73869_1_, int p_73869_2_) {
		...
		this.username.textboxKeyTyped(p_73869_1_, p_73869_2_);
		this.channelName.textboxKeyTyped(p_73869_1_, p_73869_2_);
	}
