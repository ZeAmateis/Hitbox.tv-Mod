	...
	public String generateToken() {
		...
		if (config.isTokenLoginEnabled() == true) {
			try {
				...
				FMLClientHandler.instance().getClient().thePlayer.addChatMessage(new TextComponentTranslation("(" + TextFormatting.GREEN + "HitboxTV" + TextFormatting.RESET + ") " + I18n.format("commands.hitbox.login.failed.credentials")));
			} catch (Exception e) {
