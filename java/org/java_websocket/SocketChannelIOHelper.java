...
public class SocketChannelIOHelper {
	...
	/**
	 * @see WrappedByteChannel#readMore(java.nio.ByteBuffer)
	 * @return returns whether there is more data left which can be obtained via {@link #readMore(java.nio.ByteBuffer, WebSocketImpl, WrappedByteChannel)}
	 **/
