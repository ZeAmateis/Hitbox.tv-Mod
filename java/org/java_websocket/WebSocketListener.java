...
public interface WebSocketListener {
	 ...
	 * security policy.
	 * @throws org.java_websocket.exceptions.InvalidDataException thrown when some data that is required to generate the flash-policy like the websocket local port could not be obtained.
	 */
