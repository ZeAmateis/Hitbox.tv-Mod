...
public abstract class Draft {
	...
	/**
	 * Drafts must only be by one websocket at all. To prevent drafts to be used more than once the BotCode.hbWebsocket implementation should call this method in order to create a new usable version of a given draft instance.<br>
