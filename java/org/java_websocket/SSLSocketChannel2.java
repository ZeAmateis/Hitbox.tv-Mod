...
public class SSLSocketChannel2 implements ByteChannel, WrappedByteChannel {
	/**
	 * This object is used to feed the {@link javax.net.ssl.SSLEngine}'s wrap and unwrap methods during the handshake phase.
	 **/
	 ...
	 * But because of #190 where HandshakeStatus.FINISHED is not properly returned by nio wrap/unwrap this variable is used to check whether {@link #createBuffers(javax.net.ssl.SSLSession)} needs to be called.
	 **/
	 ...
	 * Thats why it's called both from the {@link #read(java.nio.ByteBuffer)} and {@link #write(java.nio.ByteBuffer)}
	 **/
	...
	/**
	 * {@link #read(java.nio.ByteBuffer)} may not be to leave all buffers(inData, inCrypt)
	 **/
