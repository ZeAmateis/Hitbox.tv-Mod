...
public abstract class WebSocketAdapter implements WebSocketListener {
	 ...
	 * @throws org.java_websocket.exceptions.InvalidDataException thrown when some data that is required to generate the flash-policy like the websocket local port could not be obtained e.g because the websocket is not connected.
	 */
	@Override
